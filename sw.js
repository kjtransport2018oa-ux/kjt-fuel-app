...
const CACHE_NAME = 'kjt-hub-shell-v14'; // เพิ่มหน้า "นำเข้าผลตรวจสุขภาพ" ใน Admin/Supervisor (v14) + วิเคราะห์สุขภาพเชิงลึก + ระบบจองคิวซ่อมบำรุง — บังคับล้าง cache เดิมทุกเครื่อง
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
